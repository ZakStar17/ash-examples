...
#[derive(Debug)]
pub struct BufferWriteDescriptorSet {
  inner: vk::WriteDescriptorSet,
  info: vk::DescriptorBufferInfo,
  _pin: PhantomPinned,
}

impl BufferWriteDescriptorSet {
  pub fn new(
    set: vk::DescriptorSet,
    binding: u32,
    descriptor_type: vk::DescriptorType,
...
pub fn storage_buffer_descriptor_set(
  set: vk::DescriptorSet,
  binding: u32,
  info: vk::DescriptorBufferInfo,
...
#[derive(Debug)]
pub struct ImageWriteDescriptorSet {
  inner: vk::WriteDescriptorSet,
  info: vk::DescriptorImageInfo,
  _pin: PhantomPinned,
}

impl ImageWriteDescriptorSet {
  pub fn new(
    set: vk::DescriptorSet,
    binding: u32,
    descriptor_type: vk::DescriptorType,
...
pub fn texture_write_descriptor_set(
  set: vk::DescriptorSet,
